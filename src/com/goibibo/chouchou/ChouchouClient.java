...
public class ChouchouClient {
	private static String TAG = ChouchouClient.class.getSimpleName();
	private String baseUrl;
	private String params;

	public ChouchouClient(String url) {
		this.baseUrl = url;
	}

	public ChouchouClient(String url, String params) {
		this.baseUrl = url;
		this.params = params;
	}
	...
	private void addHeaders(HttpRequestBase reqType) {
		...
		reqType.setHeader(new BasicHeader("appid", "android"));
		reqType.setHeader(new BasicHeader("appkey", Utility
				.getMD5hash("android_ugc1.0")));
	}
